...
if {[info exists ::env(GOLDEN_IN)]} {
    ...
    set golden_in "../01_sim/IPU/Testbench_HAZE_REMOVAL_TOP/sim/image_global_p_test/haze_recovery_128.bmp"
}

if {[info exists ::env(OUT_DIR)]} {
    set out_dir $::env(OUT_DIR)
} else {
    set out_dir "../01_sim/IPU/Testbench_IPU_SOC/sim/image_test/"
}
...
vlog +acc +define+SIM_MODE \
    ...
    $SRC_DIR/min3_u8.sv \
    $SRC_DIR/src_min.sv \
    $SRC_DIR/search_block_min.sv \
    $SRC_DIR/spatial_min3x3.sv \
    $SRC_DIR/recip_lut_q16.sv \
    $SRC_DIR/sky_recognition.sv \
