...
set log_file [file join $log_dir "riscv_single_cycle_${ts}.log"]

transcript file $log_file
transcript on

puts "RISC-V single_cycle automation"
...
vlog +acc \
    ...
    $TB_DIR/single_cycle_tb.sv

vsim -c single_cycle_tb -do "run -all; quit -f"
