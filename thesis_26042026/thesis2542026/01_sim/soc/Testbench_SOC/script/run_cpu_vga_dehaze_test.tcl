# =============================================================================
# run_cpu_vga_dehaze_test.tcl
#
# QuestaSim script: CPU-driven IPU dehaze + VGA verification
# Image: image_test (cityscape)
#   Input : 01_sim/soc/Testbench_SOC/sim/image_test/soc_input_128.bmp
#   Output: 01_sim/soc/Testbench_SOC/sim/image_test/cpu_dehazed_128.bmp
#
# Cách chạy (từ thư mục gốc thesis2542026/):
#   vsim -do "do 01_sim/soc/Testbench_SOC/script/run_cpu_vga_dehaze_test.tcl"
# =============================================================================
...
set log_file [file join $log_dir "cpu_vga_dehaze_test_${ts}.log"]
transcript file $log_file
transcript on

puts "============================================================"
puts " CPU-Driven VGA Dehaze Test  —  image_test"
puts " Log: $log_file"
puts "============================================================"
...
set img_in  "01_sim/soc/Testbench_SOC/sim/image_test/soc_input_128.bmp"
set out_dir "01_sim/soc/Testbench_SOC/sim/image_test/"
...
#   -g dùng để override parameter MEM trong instr_mem_inst
#   Hierarchy: tb_cpu_vga_dehaze/dut/u_single_cycle/instr_mem_inst
# ─────────────────────────────────────────────────────────────────────────────
