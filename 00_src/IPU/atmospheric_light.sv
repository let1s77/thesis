...
// Description: Atmospheric Light Estimation for Dark Channel Prior Algorithm
// 
// Algorithm (theo DCP paper Section 2.3):
//   1. Scan toàn bộ frame, tìm pixel có dark_channel CAO NHẤT
//   2. Nếu nhiều pixel có dark_ch bằng nhau → chọn pixel có intensity (R+G+B) cao nhất
//   3. RGB của pixel đó là Atmospheric Light A
//
// Interface:
//   - i_frame_start: Pulse báo bắt đầu frame mới (reset accumulator)
//   - i_frame_end:   Pulse báo kết thúc frame (output A final)
//   - i_valid:       Pixel data valid
//   - i_rgb:         RGB của pixel hiện tại
//   - i_dark_ch:     Dark channel của pixel hiện tại
//   - o_A_R/G/B:     Atmospheric light RGB (valid khi o_valid=1)
//   - o_valid:       Output valid sau frame_end
//
// Latency: Output valid sau i_frame_end + 1 cycle
//==============================================================================
