...
module adc_line_buffer_5x5 #(
    ...
    // ----------------------------------------------------------------
    logic [7:0] line_buf_0 [0:IMG_WIDTH-1]; // oldest row (row 0)
    logic [7:0] line_buf_1 [0:IMG_WIDTH-1]; // row 1
    logic [7:0] line_buf_2 [0:IMG_WIDTH-1]; // row 2
    logic [7:0] line_buf_3 [0:IMG_WIDTH-1]; // row 3
